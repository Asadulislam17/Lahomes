        ...
        <div class="card">
            <div class="card-body">
                <div class="position-relative">
                    <img src="/images/properties/p-11.jpg" alt="" class="img-fluid rounded">
                ...
                <div class="d-flex flex-wrap justify-content-between my-3 gap-2">
                    <div>
                        <a href="#!" class="fs-18 text-dark fw-medium">Hayfield Ashton Place Residences at Willow Brook Valley</a>
                        <p class="d-flex align-items-center gap-1 mt-1 mb-0"><iconify-icon icon="solar:map-point-wave-bold-duotone" class="fs-18 text-primary"></iconify-icon>1668 Lincoln Drive Harrisburg, PA 17101 U.S.A</p>
                    </div>
                    <div>
                ...
                <div class="bg-light-subtle p-2 mt-3 rounded border border-dashed">
                    <div class="row align-items-center text-center g-2">
                        <div class="col-xl-2 col-lg-3 col-md-6 col-6 border-end">
                            <p class="text-muted mb-0 fs-15 fw-medium d-flex align-items-center justify-content-center gap-1"><iconify-icon icon="solar:bed-broken" class="fs-18 text-primary"></iconify-icon> 5 Bedroom
                            </p>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-6 col-6 border-end">
                            <p class="text-muted mb-0 fs-15 fw-medium d-flex align-items-center justify-content-center gap-1"><iconify-icon icon="solar:bath-broken" class="fs-18 text-primary"></iconify-icon> 4 Bathrooms
                            </p>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-6 col-6 border-end">
                            <p class="text-muted mb-0 fs-15 fw-medium d-flex align-items-center justify-content-center gap-1"><iconify-icon icon="solar:scale-broken" class="fs-18 text-primary"></iconify-icon> 1800sqft
                            </p>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-6 col-6 border-end">
                            <p class="text-muted mb-0 fs-15 fw-medium d-flex align-items-center justify-content-center gap-1"><iconify-icon icon="solar:double-alt-arrow-up-broken" class="fs-18 text-primary"></iconify-icon> 3 Floor
                            </p>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-6 col-6 border-end">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-6 col-6">
                            <p class="text-muted mb-0 fs-15 fw-medium d-flex align-items-center justify-content-center gap-1"><iconify-icon icon="solar:check-circle-broken" class="fs-18 text-primary"></iconify-icon> For Sale
                            </p>
                        </div>
